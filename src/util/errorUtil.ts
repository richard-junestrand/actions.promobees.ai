...
errors.set(100140, {id: "message.error-invalid-value", params: ["apply_template"] });
...
//
errors.set(700000, {id: "message.error-700000" });
errors.set(700010, {id: "message.error-700010" });
errors.set(700020, {id: "message.error-700020" });
